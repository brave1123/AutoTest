...
import con.course.code.model.UpdateUserInfoCase;
...
public class UpdateUserInfoTest {
    ...
    public void updateUserInfo() throws IOException, InterruptedException {
      ...
      //下边为写完接口的代码
        ...
        //获取更新后的结果
        Thread.sleep(2000);
        System.err.println("能打印出来吗："+updateUserInfoCase.toString());
	...
	private int getResult(UpdateUserInfoCase updateUserInfoCase) throws ClientProtocolException, IOException {
